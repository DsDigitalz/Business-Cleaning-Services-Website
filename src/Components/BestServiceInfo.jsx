...
export default function BestServiceInfo() {
  return (
    <section className="flex flex-col items-center  text-[#111D15] mt-10 bg-amber-50 md:flex-row md:items-center md:gap-10 md:px-10 md:py-10 lg:px-40">
      ...
      <div className="flex flex-col shadow-2xl items-center border pl-5 border-y-zinc-200 border-x-zinc-3  mt-4 bg-white p-3  md:items-start md:w-[80%] md:p-5 md:mt-0">
