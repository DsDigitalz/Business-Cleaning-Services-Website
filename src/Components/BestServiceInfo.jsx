...
export default function BestServiceInfo() {
  return (
    <section className="flex flex-col items-center text-[#111D15] mt-10 bg-amber-50 md:flex-row md:items-center md:gap-20 md:px-10">
      <div className=" text-3xl font-bold w-[70%] text-center mt-10 sm:w-[60%] md:flex md:items-center md:w-[70%] md:text-left md:mt-0">
        We Always Provide The Best Service
      </div>

      <div className="flex flex-col items-center mt-4 bg-white p-3 w-[90%] md:items-start md:w-[80%]">
