...
export default function Header() {
  ...
  return (
    <header className="relative flex flex-col lg:flex-row lg:justify-between px-5 lg:px-10 py-3 ">
      ...
      {/* Nav Info */}
        <nav className={`lg:flex lg:justify-between lg:items-center overflow-hidden`}>
          <div
            className={`lg:static lg:translate-x-0 transition-transform duration-500 ease-in-out ${
              isOpen ? "translate-x-0" : "translate-x-full  "
            } absolute top-12 right-0 w-full z-20 bg-white lg:block overflow-hidden`}
          >
            <ul className="overflow-hidden py-10 lg:py-0 flex flex-col gap-3 lg:flex-row items-center lg:gap-10 font-medium lg:visible lg:static over">
              ...
              <li className="text-center bg-[#c0fad45b] cursor-pointer hover:scale-103 transition-all duration-300 hover:text-[#36B864] hover:pb-1 hover:border-b active:text-[#21723c] p-3 lg:p-0 w-full lg:w-fit rounded lg:bg-white">
