    ...
    <section className="max-w-[1440px] mx-auto px-5 py-10 bg-[#FFFFF0] md:flex md:flex-row-reverse md:items-center  md:px-20 lg:px-40">
      <div className="flex flex-col gap-5 shadow items-center justify-center bg-white p-10 border-[#2a8f4c] border-t-10 border-r-10 rounded-4xl xl:flex-row xl:justify-between lg:flex-1">
        ...
        <div className="flex flex-col gap-2 items-center xl:items-start lg:flex-1">
          <h1 className="font font-semibold text-2xl lg:text-xl">Robert Fox</h1>
          <p>Business Woman</p>
          <div>
      ...
      <div className="flex flex-col items-center justify-center text-center mt-10 gap-2 md:items-start md:text-left lg:flex-1">
        ...
        <div className="flex gap-3 items-center">
          <button className="cursor-pointer hover:bg-[#2a8f4c] border rounded-lg border-[#2a8f4c] hover:text-white py-2 px-5 font-semibold active:bg-[#21723c] transition-all duration-300">
