...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className=" flex flex-col gap-7 absolute left-5 top-40 w-[90%] sm:absolute  md:absolute md:top-10 md:left-20 md:flex md:flex-col md:gap-1 lg:top-20 lg:left-41 lg:gap-5 lg:w-[70%] xl:top-1   2xl:top-35 2xl:w-[60%] 2xl:left-99 ">
